...
export const wfCtx = waveformCanvas.getContext('2d', { willReadFrequently: true });
export const spectrumCanvas = document.getElementById('spectrum-canvas');
export const spCtx = spectrumCanvas.getContext('2d', { willReadFrequently: true });
export const spectrogramCanvas = document.getElementById('spectrogram-canvas');
export const spectrogramCtx = spectrogramCanvas.getContext('2d', { willReadFrequently: true });
